...
web font */
        onFontsUpdated(handler: (params: CSS.FontsUpdatedEvent) => void): void;
...
resized.) The current implementation considers only viewport-dependent media features. */
    ...
    export interface CSSServer {
        /** Fires whenever a web font is updated.  A non-empty font parameter indicates a successfully loaded
web font */
        emitFontsUpdated(params: CSS.FontsUpdatedEvent): void;
...
display. Reported for diagnostic uses, may be removed in the future. */
    ...
    export interface HeadlessExperimentalCommands {
...
Only supported in headless mode.  Once set there's no way of leaving deterministic mode. */
    ...
    export interface HeadlessExperimentalClient extends HeadlessExperimentalCommands {
        /** Issued when the target starts or stops needing BeginFrames. */
        onNeedsBeginFramesChanged(handler: (params: HeadlessExperimental.NeedsBeginFramesChangedEvent) => void): void;

    }

    export interface HeadlessExperimentalServer {
        /** Issued when the target starts or stops needing BeginFrames. */
        emitNeedsBeginFramesChanged(params: HeadlessExperimental.NeedsBeginFramesChangedEvent): void;

        expose(domain: HeadlessExperimentalCommands): void;
...
for the preferred input type). */
    ...
    export interface InspectorClient extends InspectorCommands {
        ...
        onTargetReloadedAfterCrash(handler: () => void): void;
    ...
    export interface InspectorServer {
        ...
        /** Fired when debugging target has reloaded after crash */
        emitTargetReloadedAfterCrash(): void;
...
open. */
        ...
        onNavigatedWithinDocument(handler: (params: Page.NavigatedWithinDocumentEvent) => void): void;
...
open. */
        ...
        /** Fired when same-document navigation happens, e.g. due to history API usage or anchor navigation. */
        emitNavigatedWithinDocument(params: Page.NavigatedWithinDocumentEvent): void;
...
For cached script it is the last time the cache entry was validated. */
    ...
    export interface StorageClient extends StorageCommands {
        ...
        onIndexedDBContentUpdated(handler: (params: Storage.IndexedDBContentUpdatedEvent) => void): void;

        /** The origin's IndexedDB database list has been modified. */
        onIndexedDBListUpdated(handler: (params: Storage.IndexedDBListUpdatedEvent) => void): void;
    ...
    export interface StorageServer {
        ...
        /** The origin's IndexedDB object store has been modified. */
        emitIndexedDBContentUpdated(params: Storage.IndexedDBContentUpdatedEvent): void;

        /** The origin's IndexedDB database list has been modified. */
        emitIndexedDBListUpdated(params: Storage.IndexedDBListUpdatedEvent): void;
